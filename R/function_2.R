...
construct_request <- function(api.credentials,
  ...
  xml.request <- paste0('<?xml version="1.0"?>    <AccessRequest xml:lang="en-US">      <AccessLicenseNumber>', api.credentials$AccessLicenseNumber, '</AccessLicenseNumber>      <UserId>', api.credentials$UserID,'</UserId>      <Password>', api.credentials$Password,'</Password>        </AccessRequest>        <RatingServiceSelectionRequest xml:lang="en-US">          <CustomerClassification><Code>00</Code></CustomerClassification>          <Request>          <TransactionReference>          <CustomerContext>Rating and Service</CustomerContext>          </TransactionReference>          <RequestAction>Rate</RequestAction>          <RequestOption>Ratetimeintransit</RequestOption>          </Request>          <PickupType>          <Code>01</Code>          <Description>Regular Daily Pickup</Description>          </PickupType>          <Shipment>          <RateInformation>          <NegotiatedRatesIndicator/>          </RateInformation>          <DeliveryTimeInformation>          <PackageBillType>03</PackageBillType>          <Pickup>          <Date>2022-03-13</Date>          </Pickup>          </DeliveryTimeInformation>          <Shipper>          <ShipperNumber>', api.credentials$Account,'</ShipperNumber>          <Address>          <PostalCode>', shipment.data$Shipper.Postal.Code, '</PostalCode>          <StateProvinceCode>', shipment.data$Shipper.State,'</StateProvinceCode>          <CountryCode>', shipment.data$Shipper.Country,'</CountryCode>          </Address>          </Shipper>          <ShipTo>          <Address>          <ResidentialAddress>01</ResidentialAddress>          <PostalCode>', shipment.data$Recipient.Postal.Code, '</PostalCode>          <City>', shipment.data$Recipient.City, '</City>          <StateProvinceCode>', shipment.data$Recipient.State.Province, '</StateProvinceCode>          <CountryCode>', shipment.data$Recipient.Country, '</CountryCode>          </Address>          </ShipTo>          <Service>          <Code>', shipment.data$UPS.Service.Type, '</Code>          </Service>          <Package>          <PackagingType>          <Code>02</Code>          <Description>Customer Supplied</Description>          </PackagingType>          <Description>Rate</Description>          <PackageWeight>          <UnitOfMeasurement><Code>LBS</Code></UnitOfMeasurement>          <Weight>', shipment.data$Weight, '</Weight>          </PackageWeight>             </Package>          <ShipmentTotalWeight>          <UnitOfMeasurement><Code>LBS</Code></UnitOfMeasurement>          <Weight>', shipment.data$Weight, '</Weight>          </ShipmentTotalWeight>          <NumOfPieces>', shipment.data$Pieces.in.Shipment,'</NumOfPieces>          <InvoiceLineTotal>          <CurrencyCode>USD</CurrencyCode>          <MonetaryValue>0.1</MonetaryValue>          </InvoiceLineTotal>          </Shipment>          </RatingServiceSelectionRequest>')
}         
